    ...
    <section className="mt-6 space-y-3" aria-labelledby="friends-heading">
      <RunePanel>
        ...
        <div className="mt-4 border-t border-border/60 pt-4">
          ...
          <label className="mt-3 block text-xs text-muted-foreground" htmlFor="friend-code">
            {t("social.addCode")}
          </label>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 text-center">
          <div className="rounded-md border border-border/60 p-2">
            <strong className="block text-lg text-primary">{game.streak}</strong>
            <span className="text-xs text-muted-foreground">{t("social.yourStreak")}</span>
          </div>
          <div className="rounded-md border border-border/60 p-2">
            <strong className="block text-lg text-primary">{Math.floor(game.xp / 100) + 1}</strong>
            <span className="text-xs text-muted-foreground">{t("social.yourLevel")}</span>
          </div>
        </div>
      </RunePanel>
    </section>
