...
export const EQUIPMENT: EquipmentItem[] = [
  // Weapons
  { id: "worn-iron-blade", slot: "weapon", name: "Worn Iron Blade", flavor: "Every legend begins with humble steel.", levelReq: 1, icon: "sword" },
  { id: "emberforged-sword", slot: "weapon", name: "Emberforged Sword", flavor: "Quenched in dragonfire, warm to the touch.", levelReq: 5, icon: "flame-sword" },
  { id: "moonlit-runesaber", slot: "weapon", name: "Moonlit Runesaber", flavor: "Its runes glow beneath a full moon.", levelReq: 10, icon: "moon-sword" },
  { id: "dragonfang-greatblade", slot: "weapon", name: "Dragonfang Greatblade", flavor: "Carved from the fang of Vharos the Ashwing.", levelReq: 18, icon: "swords" },
  // Armor
  { id: "travelers-garb", slot: "armor", name: "Traveler's Garb", flavor: "Dusty, patched, and dependable.", levelReq: 1, icon: "shirt" },
  { id: "squires-plate", slot: "armor", name: "Squire's Plate", flavor: "First true armor of the Keep.", levelReq: 4, icon: "shield" },
  { id: "runebound-aegis", slot: "armor", name: "Runebound Aegis", flavor: "Wards hum softly across the plates.", levelReq: 12, icon: "shield-glow" },
  { id: "celestial-warplate", slot: "armor", name: "Celestial Warplate", flavor: "Forged from a fallen star's heart.", levelReq: 22, icon: "star-shield" },
  // Relics
  { id: "cracked-mana-stone", slot: "relic", name: "Cracked Mana Stone", flavor: "It still hums with faint power.", levelReq: 1, icon: "gem" },
  { id: "whispering-amulet", slot: "relic", name: "Whispering Amulet", flavor: "It murmurs advice only you can hear.", levelReq: 6, icon: "amulet" },
  { id: "eye-of-the-observatory", slot: "relic", name: "Eye of the Observatory", flavor: "Sees the path before you walk it.", levelReq: 14, icon: "eye" },
  { id: "heart-of-aethora", slot: "relic", name: "Heart of Aethora", flavor: "The realm's own pulse, carried in your palm.", levelReq: 25, icon: "heart" },
];
