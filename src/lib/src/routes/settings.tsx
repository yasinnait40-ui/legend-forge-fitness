...
// Matches the exact pattern used in achievements.tsx (createFileRoute, RealmScreen, RunePanel, RuneHeading)
...
import hallOfLegends from "@/assets/hall-of-legends.jpg"; // reuse an existing background; swap if you have a dedicated one
